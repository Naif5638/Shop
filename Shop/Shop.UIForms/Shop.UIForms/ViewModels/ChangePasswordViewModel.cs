...
namespace Shop.UIForms.ViewModels
{
    ...
    {
        //INFO: Se necesita consumir el Service
        private readonly ApiService apiService;

        //INFO: Se utilizan para indicar que esta ejecutandose el ActivityIndicator
        private bool isRunning;
        private bool isEnabled;

        //INFO: Propiedad que almacena la contraseña actual
        public string CurrentPassword { get; set; }

        //INFO: Propiedad que almacena la nueva contraseña
        public string NewPassword { get; set; }

        //INFO: Propiedad que almacena la confirmacion de la nueva contraseña
